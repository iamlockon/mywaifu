...
import { MdOutlineExplore, MdOutlineGavel } from "react-icons/md";
    ...
    >
      <div className="flex justify-between w-full items-center">
        ...
        <section className="flex items-center">
          <Link
            to="/about"
            className="mx-2 px-3 py-1 bg-yellow-300 rounded-md shadow-sm hover:bg-yellow-400 transition"
          >
            <span className="hidden xs:block">About</span>{" "}
